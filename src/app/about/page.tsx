...
const jsonLd = {
  ...
  description:
    "Modern physiotherapy and rehabilitation clinic focused on evidence-based care and root-cause treatment.",
};
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl md:text-5xl font-bold text-slate-900 mb-6 leading-tight">
                Our Story: A Commitment to{" "}
                <span className="text-green-600">Patient-Centered</span> Care
              </h2>
              <div className="space-y-6 text-lg text-slate-600 leading-relaxed">
                <p>
                  Aatral360 was established with a singular, driving purpose: to
                  elevate the standard of physiotherapy by shifting the focus
                  from temporary symptom management to sustainable, long-term
                  recovery.
                </p>
                <p>
                  We recognized a profound need in the community for clinical
                  care that addresses the <strong>root causes</strong> of
                  movement dysfunction and pain. Too often, patients are rushed
                  through treatments that only offer fleeting relief. We wanted
                  to create a sanctuary of healing where every patient is heard,
                  rigorously assessed, and comprehensively treated.
                </p>
                <p>
                  Today, Aatral360 stands as a modern rehabilitation center
                  where evidence-based science meets compassionate human
                  connection. We don&apos;t just treat injuries; we treat the
                  individual, empowering you to reclaim your active lifestyle
                  with confidence.
                </p>
              </div>
            </div>
            <div className="relative">
              ...
              <div className="bg-white p-10 rounded-3xl shadow-xl border border-slate-100">
                ...
                <p className="text-2xl font-medium text-slate-800 leading-snug italic">
                  &quot;Our mission goes beyond alleviating pain. We are here to
                  rebuild resilience, restore function, and educate our patients
                  so they can take control of their own physical health.&quot;
                </p>
              ...
              <div className="lg:col-span-7 p-10 md:p-16 lg:p-20">
                <div className="mb-8">
                  <h3 className="text-3xl md:text-4xl font-bold text-slate-900 mb-2">
                    Dr. Sarath Kumar N,{" "}
                    <span className="text-green-600">PT</span>
                  </h3>
                ...
                <div className="space-y-8">
                  <div>
                    ...
                    <ul className="space-y-2 text-slate-600">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          <strong>Master of Sports Physiotherapy</strong> (MPT –
                          Sports)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="w-5 h-5 text-green-500 shrink-0 mt-0.5" />
                        <span>
                          <strong>9+ Years</strong> of dedicated clinical
                          experience
                        </span>
                      </li>
                    </ul>
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 leading-relaxed">
                      Dr. Sarath firmly believes in evidence-based assessment,
                      personalized treatment planning, and patient education.
                      His approach focuses on uncovering and treating the
                      biomechanical root causes of pain rather than offering
                      temporary symptom relief, ensuring patients achieve
                      sustainable, long-term functional outcomes.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-slate-50 p-10 md:p-14 rounded-3xl border border-slate-100 relative overflow-hidden group">
              ...
              <p className="text-lg text-slate-600 leading-relaxed relative z-10">
                To transform lives by integrating rehabilitation, movement,
                performance, and wellness into one personalized, evidence-based
                approach that helps every individual achieve lifelong health and
                confidence.
              </p>
            </div>
        ...
        <div className="container">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="mt-4 text-lg text-slate-600">
              Comprehensive, evidence-based treatments tailored to address
            ...
            {[
              {
                ...
                desc: "Advanced protocols to return athletes safely to peak performance.",
                icon: Activity,
              },
              {
                title: "Musculoskeletal Physiotherapy",
                desc: "Expert management of muscle, joint, and soft tissue disorders.",
                icon: Dna,
              },
              {
                title: "Post-Surgical Recovery",
                desc: "Structured rehabilitation to restore mobility and strength after surgery.",
                icon: Stethoscope,
              },
              {
                title: "Spine Rehabilitation",
                desc: "Targeted care for complex cervical, thoracic, and lumbar conditions.",
                icon: Shield,
              },
              {
                title: "Movement Retraining",
                desc: "Correcting faulty biomechanics to prevent chronic injury recurrence.",
                icon: LineChart,
              },
              {
                title: "Corrective Exercise",
                desc: "Prescriptive, functional exercises tailored to your specific deficits.",
                icon: ClipboardCheck,
              },
            ].map((area, i) => (
              <div
                key={i}
                className="bg-white p-8 rounded-2xl border border-slate-100 hover:border-green-300 hover:shadow-xl transition-all duration-300 group"
              >
      ...
      <section className="py-24 bg-white border-t border-slate-200/60">
        <div className="container">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="mt-4 text-lg text-slate-600">
              The pillars of our practice that ensure you receive exceptional
              care.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Protocols validated by the latest medical research.",
              },
              {
                title: "Personalized Treatment",
                desc: "Individualized care plans, no generic routines.",
              },
              {
                title: "Patient Education",
                desc: "Understanding your body is the first step to healing.",
              },
              {
                title: "Ethical Practice",
                desc: "Transparent, honest, and patient-first clinical decisions.",
              },
              {
                title: "Modern Rehabilitation",
                desc: "Integrating advanced therapeutic modalities.",
              },
              {
                title: "Long-Term Recovery Focus",
                desc: "Building lasting strength and preventing recurrence.",
              },
            ].map((trust, i) => (
              <div
                key={i}
                className="bg-white p-8 rounded-2xl border border-slate-100 shadow-sm flex flex-col items-center text-center hover:border-green-300 hover:shadow-xl hover:shadow-green-900/5 transition-all"
              >
        ...
        <div className="container">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
            {[
              ...
              <div
                key={i}
                className={`text-center ${i > 0 ? "lg:border-l lg:border-slate-200 lg:pl-8" : ""}`}
              >
          ...
          <div className="bg-slate-50 rounded-4xl p-10 md:p-16 text-center border border-slate-200 shadow-xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-lg text-slate-600 mb-10 max-w-2xl mx-auto">
                Don&apos;t let pain or mobility issues dictate your life.
                Schedule an assessment with Dr. Sarath Kumar N and take the
