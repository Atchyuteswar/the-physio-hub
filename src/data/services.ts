...
export const services: Service[] = [
  {
    ...
    image: "/images/our-services/musculoskeletal-rehabilitation.png",
    description:
    ...
    approachSections: [
      ...
      },
      {
        ...
        description:
          "When clinically indicated, we utilize evidence-based manual therapy techniques to reduce pain, improve mobility, and prepare the body for active rehabilitation. These may include:",
        items: [
      ...
      },
      {
        ...
        description:
          "As symptoms improve, rehabilitation progresses toward restoring normal movement through:",
        items: [
    ...
    recoveryTimeline: [
      ...
      {
        condition: "Post-Operative Orthopaedic Rehabilitation",
        duration: "8–24+ weeks",
      },
    ],
    timelineNote:
      "Recovery timelines vary based on the individual's condition, medical history, surgical procedures, rehabilitation goals, and participation in the prescribed program.",
    differenceText:
      "At Aatral360, rehabilitation is not limited to symptom relief. Our goal is to restore efficient movement, improve physical capacity, reduce the risk of recurrence, and empower every individual to return confidently to work, sport, and everyday life through personalized, evidence-based rehabilitation.",
    process: [
      {
        title: "Comprehensive Assessment",
        description:
          "We evaluate your clinical history, movement patterns, joint and soft tissue function, and strength to build a complete picture.",
      },
      {
        title: "Pain Modulation & Active Rehabilitation",
        description:
          "Evidence-based manual therapy and progressive exercises to reduce pain, restore mobility, and rebuild motor control.",
      },
      {
        title: "Strength & Functional Restoration",
        description:
          "Progressively building strength, endurance, and functional capacity for confident return to daily life, work, or sport.",
      },
    ],
    faqs: [
      {
        ...
        answer:
          "Our musculoskeletal rehabilitation goes beyond symptom relief. We focus on restoring movement quality, building physical capacity, and reducing recurrence risk through a comprehensive, evidence-based approach.",
      },
      {
        question: "How long does rehabilitation typically take?",
        answer:
          "Recovery timelines vary by condition — from 2–6 weeks for mild strains to 6–12 months for ligament reconstruction. Your physiotherapist will provide a personalized timeline after assessment.",
      },
      {
        question: "Do I need imaging before starting rehabilitation?",
        answer:
          "Not always. We use clinical reasoning and movement assessment to guide treatment. Imaging is recommended only when clinically indicated.",
      },
    ],
  },
  {
    ...
    image: "/images/our-services/chronic-pain-rehabilitation.png",
    description:
    ...
    approachSections: [
      {
        title: "Comprehensive Assessment",
        description:
          "Every rehabilitation journey begins with understanding the complete picture. We assess:",
        items: [
      ...
      },
      {
        ...
        description:
          "When clinically appropriate, evidence-based interventions may be used to reduce pain and improve tolerance to movement, including:",
        items: [
          "Manual Therapy",
          "Joint Mobilization",
          "Myofascial Release",
      ...
      },
      {
        ...
        description:
          "Long-term improvement depends on restoring the balance between what your body is asked to do and what it is capable of doing.",
        items: [
      ...
      },
      {
        ...
        description:
          "Exercise is the foundation of successful chronic pain rehabilitation. Every exercise program is tailored according to:",
        items: [
          "Your diagnosis",
    ...
    recoveryTimeline: [
      ...
      {
        condition: "Complex Chronic Pain Conditions",
        duration: "Individualized long-term rehabilitation",
      },
    ],
    differenceText:
      "We believe lasting pain relief is achieved by improving movement quality, increasing physical capacity, and helping people confidently return to the activities that matter most. Our goal is not simply to reduce pain for today, but to build the knowledge, resilience, and movement capacity needed for long-term health and independence.",
    process: [
      {
        title: "Comprehensive Pain Assessment",
        description:
          "We evaluate pain characteristics, movement quality, physical capacity, lifestyle demands, and contributing factors.",
      },
      {
        title: "Pain Modulation & Load Management",
        description:
          "Evidence-based interventions to reduce pain combined with progressive load management and capacity building.",
      },
      {
        title: "Individualized Exercise & Self-Management",
        description:
          "Tailored exercise programs and education to build long-term resilience and movement confidence.",
      },
    ],
    faqs: [
      {
        ...
        answer:
          "Programs typically range from 6–16 weeks for persistent pain conditions. Complex cases may require individualized long-term rehabilitation.",
      },
      {
        question: "Is exercise safe for chronic pain?",
        answer:
          "Yes. Exercise is the foundation of chronic pain rehabilitation. Programs are carefully tailored to your irritability, capacity, and goals.",
      },
      {
        question: "Do I need a doctor's referral?",
        answer:
          "No, you can directly book an appointment for assessment and rehabilitation.",
      },
    ],
  },
  {
    ...
    image: "/images/our-services/sports-injury-rehabilitation.png",
    description:
    ...
    approachSections: [
      {
        ...
        description:
          "Every rehabilitation program begins with a comprehensive evaluation, including:",
        items: [
      ...
      },
      {
        ...
        description:
          "Rehabilitation progresses through structured phases, ensuring each stage prepares you for the next:",
        items: [
      ...
      },
      {
        ...
        description:
          "Before returning to unrestricted training or competition, athletes undergo objective performance testing to evaluate readiness:",
        items: [
          "Strength assessment",
    ...
    timelineNote:
      "Return-to-sport decisions are based on objective functional testing, physical readiness, and sport-specific demands—not simply the passage of time.",
    differenceText:
      "At Aatral360, successful rehabilitation means more than returning to activity. We combine evidence-based physiotherapy, strength and conditioning, load management, and performance training to help athletes recover safely, restore physical capacity, reduce the risk of re-injury, and return to performing at their highest potential.",
    process: [
      {
        title: "Athlete-Centered Assessment",
        description:
          "We evaluate your injury, sport-specific demands, training history, and performance goals.",
      },
      {
        title: "Progressive Sports Rehabilitation",
        description:
          "Structured phases from tissue healing through strength, neuromuscular control, and sport-specific skill integration.",
      },
      {
        title: "Return-to-Sport Testing & Performance",
        description:
          "Objective functional testing to ensure safe, confident return to competition at your highest level.",
      },
    ],
    faqs: [
      {
        ...
        answer:
          "Return-to-sport decisions are based on objective functional testing and physical readiness, not simply time elapsed since injury.",
      },
      {
        question: "Is this suitable for recreational athletes?",
        answer:
          "Yes, our programs are designed for recreational, competitive, and elite athletes across all sports.",
      },
      {
        question: "Will exercises be sport-specific?",
        answer:
          "Yes, rehabilitation progresses to include sport-specific conditioning, agility, plyometrics, and performance tasks.",
      },
    ],
  },
  {
    ...
    subtitle:
      "Guided Recovery. Progressive Rehabilitation. Confident Return to Life.",
    image: "/images/our-services/post-operative-rehabilitation.jpg",
    description:
    ...
    approachSections: [
      {
        ...
        description:
          "From the first rehabilitation session, our physiotherapists work alongside your surgeon's recommendations, considering:",
        items: [
    ...
    timelineNote:
      "Rehabilitation timelines are individualized and may vary based on healing, surgical findings, overall health, and functional goals.",
    differenceText:
      "At Aatral360, post-operative rehabilitation is more than following a protocol. We combine surgeon-guided precautions with evidence-based physiotherapy, progressive exercise, movement restoration, and functional training to help every individual recover safely, regain independence, and confidently return to the activities that matter most.",
    process: [
      {
        title: "Post-Surgical Assessment",
        description:
          "We evaluate your surgical report, healing stage, restrictions, and recovery goals to design a safe rehabilitation plan.",
      },
      {
        title: "Five-Phase Progressive Rehabilitation",
        description:
          "Structured phases from protection and pain management through strength, capacity building, and return to activity.",
      },
      {
        title: "Functional Training & Return to Life",
        description:
          "Preparing you for daily activities, work, and sport with advanced functional training and goal-specific progression.",
      },
    ],
    faqs: [
      {
        ...
        answer:
          "Post-operative rehabilitation typically begins as soon as your surgeon clears you, often within the first week after surgery.",
      },
      {
        question: "Do you coordinate with my surgeon?",
        answer:
          "Yes, our rehabilitation plans are developed in close collaboration with your surgeon's recommendations and precautions.",
      },
      {
        question: "How long does post-operative rehabilitation take?",
        answer:
          "Timelines vary from 4–8 weeks for arthroscopic procedures to 9–15 months for complex ligament reconstructions.",
      },
    ],
  },
  {
    ...
    subtitle:
      "Restoring Function. Maximizing Independence. Improving Quality of Life.",
    image: "/images/our-services/neurological-rehabilitation.png",
    description:
    ...
    approachSections: [
      {
        ...
        description:
          "Every rehabilitation program begins with a detailed evaluation of:",
        items: [
          "Functional mobility",
          "Muscle strength",
      ...
      },
      {
        title: "Our Goals",
        description:
          "Our neurological rehabilitation programs focus on helping individuals:",
        items: [
    ...
    timelineNote:
      "Neurological rehabilitation is individualized, and progress varies between individuals. Rehabilitation focuses on maximizing functional independence and long-term quality of life.",
    differenceText:
      "At Aatral360, neurological rehabilitation is centered on helping people regain meaningful function, improve independence, and participate confidently in everyday life. Through evidence-based physiotherapy, functional training, and individualized rehabilitation, we support each person's journey toward achieving their highest possible level of recovery and independence.",
    process: [
      {
        title: "Comprehensive Neurological Assessment",
        description:
          "We evaluate mobility, strength, balance, coordination, gait, and functional independence.",
      },
      {
        title: "Evidence-Based Rehabilitation Program",
        description:
          "Motor control retraining, functional task training, balance exercises, and progressive strengthening.",
      },
      {
        title: "Functional Independence & Goal Achievement",
        description:
          "Building independence in daily activities, reducing fall risk, and maximizing long-term recovery.",
      },
    ],
    faqs: [
      {
        ...
        answer:
          "Some conditions like Parkinson's Disease and Multiple Sclerosis benefit from ongoing rehabilitation. Others, like stroke recovery, may have defined phases with measurable goals.",
      },
      {
        question: "Can physiotherapy help after a stroke?",
        answer:
          "Yes. Post-stroke rehabilitation can significantly improve movement, balance, walking ability, and functional independence.",
      },
      {
        question: "Do you provide caregiver education?",
        answer:
          "Yes, we include caregiver education and home exercise programs as part of our rehabilitation approach.",
      },
    ],
  },
  {
    ...
    image: "/images/our-services/womens-health-physiotherapy.png",
    description:
    ...
    recoveryTimeline: [
      {
        condition: "Pregnancy Exercise Program",
      ...
      {
        condition: "Pregnancy-Related Back or Pelvic Pain",
        duration: "4–12 weeks",
      },
    ],
    timelineNote:
      "Recovery timelines are individualized and depend on assessment findings, symptom severity, and participation in the rehabilitation program.",
    differenceText:
      "At Aatral360, Women's Health Physiotherapy focuses on restoring movement, improving core and pelvic floor function, reducing pain, and supporting women through every stage of pregnancy, postpartum recovery, and beyond. Our goal is to help every woman move with confidence, regain physical strength, and return safely to the activities that matter most.",
    process: [
      {
        title: "Comprehensive Assessment",
        description:
          "We evaluate posture, core and pelvic floor function, strength, mobility, and daily activity demands.",
      },
      {
        title: "Personalized Rehabilitation Program",
        description:
          "Safe, stage-appropriate exercises including pelvic floor training, core strengthening, and functional movement.",
      },
      {
        title: "Recovery & Return to Activity",
        description:
          "Progressive strengthening and education to regain confidence and safely return to exercise and daily activities.",
      },
    ],
    faqs: [
      {
        ...
        answer:
          "Postnatal rehabilitation can typically begin 6 weeks after vaginal delivery or as advised by your obstetrician after a cesarean section.",
      },
      {
        question: "Is it safe to exercise during pregnancy?",
        answer:
          "Yes. We design pregnancy-safe exercise programs tailored to your stage of pregnancy and physical condition.",
      },
      {
        question: "Can physiotherapy help with urinary incontinence?",
        answer:
          "Yes. Pelvic floor rehabilitation is an effective, evidence-based approach for managing urinary incontinence.",
      },
    ],
  },
  {
    ...
    subtitle:
      "Restoring Function. Supporting Recovery. Improving Quality of Life.",
    image: "/images/our-services/oncology-rehabilitation.png",
    description:
  ...
  },
  {
    ...
    image: "/images/our-services/corporate-health-wellness-programs.png",
    description:
    ...
    approachSections: [
      {
        ...
        description:
          "Every corporate program begins with understanding the physical demands of your workplace. Our assessments may include:",
        items: [
      ...
      },
      {
        ...
        description:
          "Where appropriate, our wellness programs may include periodic assessment of:",
        items: [
    ...
    recoveryTimeline: [
      ...
      {
        condition: "Workplace Health Workshop",
      ...
      {
        condition: "Annual Workplace Wellness Partnership",
        duration: "Ongoing",
      },
    ],
    differenceText:
      "At Aatral360, we believe workplace wellness extends beyond correcting posture. Our programs integrate ergonomics, movement science, exercise prescription, stress management, and preventive healthcare to help employees move better, work comfortably, improve physical resilience, and maintain long-term health. By creating healthier individuals, we help organizations build more productive, engaged, and sustainable workplaces.",
    process: [
      {
        title: "Workplace Health Assessment",
        description:
          "We evaluate ergonomics, movement patterns, postural habits, and musculoskeletal risk factors in your workplace.",
      },
      {
        title: "Customized Wellness Program",
        description:
          "Evidence-based programs including ergonomics education, exercise sessions, stress management, and injury prevention.",
      },
      {
        title: "Monitoring & Long-Term Partnership",
        description:
          "Periodic health assessments, progress tracking, and ongoing wellness support for sustained workplace health.",
      },
    ],
    faqs: [
      {
        ...
        answer:
          "Yes. Programs can be delivered on-site, at our rehabilitation center, or in hybrid formats depending on organizational requirements.",
      },
      {
        question: "Is this suitable for small businesses?",
        answer:
          "Yes. Our programs are suitable for organizations of all sizes, from small enterprises to large corporations.",
      },
      {
        question: "How long is a typical corporate wellness program?",
        answer:
          "Programs range from single awareness sessions (60–90 minutes) to comprehensive 6–12 week programs or ongoing annual partnerships.",
      },
    ],
  },
  {
    ...
    image: "/images/our-services/vertigo-vestibular-rehabilitation.png",
    description:
    ...
    approachSections: [
      {
        ...
        description:
          "A thorough evaluation of your balance and vestibular system, including:",
        items: [
    ...
    differenceText:
      "At Aatral360, we understand how debilitating vertigo can be. Our specialized vestibular rehabilitation focuses on identifying the root cause of your dizziness and providing immediate, effective interventions (like repositioning maneuvers) alongside progressive exercises to restore your equilibrium.",
    faqs: [
      {
        question: "How quickly can BPPV be treated?",
        answer:
          "In many cases, BPPV can be resolved in just 1 to 3 sessions using specific repositioning maneuvers like the Epley maneuver.",
      },
      {
        question: "Will the exercises make me dizzy?",
        answer:
          "Some exercises may temporarily provoke your symptoms; this is a normal part of the habituation process. We will guide you on how to perform them safely.",
      },
    ],
  },
  {
    ...
    image: "/images/our-services/lymphedema-management.jpg",
    description:
    ...
    approachSections: [
      {
        ...
        description:
          "The gold standard for lymphedema management, which includes:",
        items: [
    ...
    differenceText:
      "Our certified lymphedema therapists provide compassionate, expert care using the full spectrum of Complete Decongestive Therapy. We focus not only on immediate fluid reduction but also on equipping you with the tools and garments needed for successful long-term management.",
    faqs: [
      {
        question: "What is Manual Lymphatic Drainage (MLD)?",
        answer:
          "MLD is a gentle, skin-stretching massage that helps redirect lymphatic fluid from swollen areas to healthy lymphatic vessels.",
      },
      {
        question: "Do I have to wear compression garments forever?",
        answer:
          "Lymphedema is a chronic condition, so lifelong management is typically required. Compression garments are a crucial part of maintaining the fluid reduction achieved during therapy.",
      },
    ],
  },
];
