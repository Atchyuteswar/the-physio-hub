...
export default function HeroSection() {
  return (
    <section className="relative bg-slate-950 pt-20 pb-24 lg:pt-24 lg:pb-32 overflow-hidden flex items-center text-white">
      {/* Background Image */}
      ...
      <div className="container relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div className="max-w-2xl">
            ...
            <p className="mt-6 text-lg md:text-xl text-slate-300 leading-relaxed animate-fade-in-up delay-100 max-w-xl">
              <strong>
                Personalized evidence-based care that restores movement, builds
                resilience, and empowers you to perform at your best
              </strong>
              .
            </p>
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4 animate-fade-in-up delay-200 w-full sm:w-auto">
              <Link
                ...
                className="btn-primary py-3.5 px-5 sm:px-8 text-base shadow-lg shadow-green-600/20 hover:shadow-green-600/30 w-full sm:w-auto"
              >
                Book Appointment
              ...
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 bg-white hover:bg-slate-50 text-slate-700 border border-slate-300 font-semibold py-3.5 px-5 sm:px-8 text-base rounded-xl transition-all shadow-sm w-full sm:w-auto"
              >
                Explore Services
              </Link>
            </div>

            <div className="mt-10 pt-8 border-t border-slate-800/60 grid grid-cols-1 sm:grid-cols-3 gap-4 animate-fade-in-up delay-300">
              {[
                "Personalized Care",
          ...
          <div className="relative animate-fade-in lg:ml-auto mt-12 lg:mt-0 w-full max-w-lg lg:max-w-xl mx-auto min-h-75 lg:min-h-100">
            {/* Floating Card 1 */}
